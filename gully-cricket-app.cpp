...
int main()
{
    ...
    teamA.players[2] = "Ruturaj";
    teamA.name = "TeamA";

    Team teamB;
    teamB.players[0] = "Rohit";
    teamB.players[1] = "Yuvraj";
    ...
    cout << "\n*********** TeamB needs " << teamA.runs + 1 << " runs to win ***********" << endl
         << endl;
...
void startInning(int inning, string batTeam, string bowlTeam)
{
    ...
    cout << "|----- " << batTeam << " is batting and " << bowlTeam << " is bowling -----|" << endl
         << endl;
}
